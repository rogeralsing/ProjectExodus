...
namespace Proto.Router
{
    ...
    {
        public static Props NewBroadcastGroup(params PID[] routees)
        {
            return Props.Empty.WithSpawner(Spawner(new BroadcastGroupRouterConfig(routees)));
        }

        public static Props NewConsistentHashGroup(params PID[] routees)
        {
            return Props.Empty.WithSpawner(Spawner(new ConsistentHashGroupRouterConfig(MD5Hasher.Hash, 100, routees)));
        }

        public static Props NewConsistentHashGroup(Func<string, uint> hash, int replicaCount, params PID[] routees)
        {
            return Props.Empty.WithSpawner(Spawner(new ConsistentHashGroupRouterConfig(hash, replicaCount, routees)));
        }

        public static Props NewRandomGroup(params PID[] routees)
        {
            return Props.Empty.WithSpawner(Spawner(new RandomGroupRouterConfig(routees)));
        }

        public static Props NewRandomGroup(int seed, params PID[] routees)
        {
            return Props.Empty.WithSpawner(Spawner(new RandomGroupRouterConfig(seed, routees)));
        }

        public static Props NewRoundRobinGroup(params PID[] routees)
        {
            return Props.Empty.WithSpawner(Spawner(new RoundRobinGroupRouterConfig(routees)));
        }
